...
function main(){
    ...
    files = new Array()
    files[0] = decodeURI("D:\\path\\to\\file.png");
    files[1] = decodeURI("D:\\path\\to\\file.png");
    files[2] = decodeURI("D:\\path\\to\\file.png");

    load_files_into_stack(files);
}

function load_files_into_stack(files) {
